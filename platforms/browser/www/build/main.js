...
var LoginPage = /** @class */ (function () {
    ...
    LoginPage.prototype.loginAction = function () {
        ...
        if (this.email.value) {
            ...
            var browser_1 = this.iab.create('https://appstore.mahindra.com/saml', '_blank', {
                location: 'yes'
            });
            browser_1.on('loadstop').subscribe(function (data) {
                ...
                _this.nativeStorage.setItem('userData', obj)
                    ...
                    _this.nativeStorage.getItem('userData')
                        .then(function (data) {
                        _this.serviceProvider.getUsrRoleDetails('https://emss.mahindra.com/sap/bc/zsi_user_detail', '500', 211779, 'DTA').subscribe(function (response) {
                        ...
                        _this.commonProvider.showToast(error.message);
                    });
